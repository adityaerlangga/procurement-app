# [E-Procurement VhiWEB](https://soft-ui-dashboard-laravel.creative-tim.com/login)
...
*Frontend version*: E-Procurement VhiWEB v1.0.0. More info at https://www.creative-tim.com/product/soft-ui-dashboard
...
What happens when you combine E-Procurement VhiWEB, one of the hottest design trends right now, and Laravel?  We've partnered with [UPDIVISION](https://updivision.com/) to create the ultimate design & development toolbox. 

E-Procurement VhiWEB comes with dozens of handcrafted UI elements tailored for Bootstrap 5 and an out of the box Laravel backend.

## What am I getting?
You're getting a multi-purpose tool for building complex apps.

E-Procurement VhiWEB PRO Laravel at a glance:
...
Whether you're working on a side project or delivering to a client, we've got you covered. E-Procurement VhiWEB is released under MIT license, so you can use it both for personal and commercial projects for free. All you need to do is start coding. 


## Detailed documentation and example pages
We also included detailed documentation for every component and feature so you can follow along. The pre-built example pages give you a quick glimpse of what E-Procurement VhiWEB has to offer so you can get started in no time. 

If you want to get more features, go PRO with [E-Procurement VhiWEB PRO Laravel](https://www.creative-tim.com/product/soft-ui-dashboard-pro-laravel).
...
## Documentation
The documentation for the E-Procurement VhiWEB is hosted at our [website](https://soft-ui-dashboard-laravel.creative-tim.com/documentation/getting-started/overview.html).
...
## Reporting Issues
We use GitHub Issues as the official bug tracker for the E-Procurement VhiWEB. Here are some advices for our users that want to report an issue:

1. Make sure that you are using the latest version of the E-Procurement VhiWEB. Check the CHANGELOG from your dashboard on our [website](https://www.creative-tim.com/product/soft-ui-dashboard-pro-laravel?ref=readme-sudpl).
