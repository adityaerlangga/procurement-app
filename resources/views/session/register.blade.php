              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form role="form" method="POST" action="/register">
                    ...
                    <div class="mb-3">
                      <input type="text" class="form-control" name="name" id="name" value="{{ old('name') }}" placeholder="Vendor Name" aria-label="Vendor Name" aria-describedby="name-addon">
                      @error('name')
                    ...
                    <label>Address</label>
                    <div class="mb-3">
                      <input type="text" class="form-control" name="address" id="address" value="{{ old('address') }}" placeholder="Address" aria-label="Address" aria-describedby="address-addon">
                      @error('address')
                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                      @enderror
                    </div>
